      ...
      <div className="relative max-w-3xl mx-auto px-6 pt-12">
        ...
        <section className="mt-10">
          <div className="mx-auto max-w-xl">
            <h2 className="text-left font-qurova ch-gradient-text mb-2" style={{ fontSize: "32px" }}>Log in</h2>
            <p className="text-left mb-6 font-area ch-text">
              Use the same email for login as the one used during registration.
            </p>
            ...
            <div className="flex flex-col gap-4 items-center">
              ...
              >
                ...
                <span className="font-qurova" style={{ color: MainColors.text }}>Log in with Google</span>
              </button>

              {/* Apple Sign-in can be added later for web when configured */}
              {/* <button className="w-full max-w-xl h-12 rounded-xl flex items-center justify-center gap-3" style={{ backgroundColor: MainColors.orange }}>
                <Image src="/cryptic-assets/apple-logo.svg" alt="Apple" width={24} height={24} />
                <span className="font-semibold" style={{ color: MainColors.text }}>Log in with Apple</span>
              </button> */}
            </div>
          </div>
        </section>
